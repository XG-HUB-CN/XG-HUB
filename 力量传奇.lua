...
local function HeartbeatUpdate()
    ...
    FpsLabel.Text = ("XG时间:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
Start = tick()
...
local UITab3 = win:Tab("『出生榜』",'16448')
...
local UITab5 = win:Tab("『复制脚本群系列』",'16448')

local about = UITab5:section("『LENG Script』",true)

    about:Button("点我复制脚本交流群群",function()
    setclipboard("8158059")
end)
...
local UITab10 = win:Tab("『自动』",'16060333448')
...
local UITab11 = win:Tab("『跑步机』",'16060333448')
...
local UITab12 = win:Tab("『石头』",'16060333448')
...
local UITab13 = win:Tab("『重生』",'16060333448')
...
local UITab14 = win:Tab("『传送』",'16060333448')
...
local UITab15 = win:Tab("『改』",'16060333448')
...
local UITab16 = win:Tab("『卧推』",'16060333448')
...
local UITab17 = win:Tab("『丢石头』",'16060333448')
