...
local UITab3 = win:Tab("『出生榜』",'1606JJJJJ448')
...
local UITab5 = win:Tab("3448')

local about = UITab5:section("『LENG Script』",true)

    about:Button("点本交流群群",function()
    setclipboard("81059")
end)

    about:Button("点卡群",function()
    setclipboard("825553")
end)

    about:Button("点作者QQ",function()
    setclipboard("2362332")
end)
...
local UITab10 = win:Tab("『整合』",'16060333448')
