...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/LENG8123/UI/refs/heads/main/%E5%86%B7library.lua"))()
    local window = library:new("XG脚本-狗熊岭危机")   

local creds = window:Tab("帮助榜", "60229")
...
local creds = window:Tab("出生榜", "6037229")
local about = creds:section("信息", true)
...
about:Button("群群",function()
    setclipboard("8059")
end)

    about:Button("群",function()
    setclipboard("825753")
end)

    about:Button("点者QQ",function()
    setclipboard("32")
end)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoFenHG/Dex-Explorer/refs/heads/main/Dex-Explorer.lua"))()
   ...
   about:Toggle("第四章透视","MainStorage",false,function(state)
    ...
    local creds = window:Tab("传送玩家", "16060333448")
...
local creds = window:Tab("娱乐+反作弊绕过", "16060333448")
...
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(args))
    ...
    local creds = window:Tab("娱乐+移除模型", "16060333448")
...
local creds = window:Tab("自动化", "16060333448")
...
local creds = window:Tab("透视", "16060333448")
